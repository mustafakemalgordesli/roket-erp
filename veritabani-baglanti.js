...
const veritabanıBaglan = () => {
    ...
    connection.connect(function(err) {
        ...
        connection.connect(function(err) {
            ...
            var sql_stok = "CREATE TABLE IF NOT EXISTS stok_takip (id INT AUTO_INCREMENT PRIMARY KEY, urun_adi VARCHAR(100), birim VARCHAR(100), miktar INT, stok_giris DATE DEFAULT CURRENT_TIMESTAMP, stok_cikis DATE DEFAULT CURRENT_TIMESTAMP, stok_giren VARCHAR(100), stok_cikan VARCHAR(100), aciklama VARCHAR(255))"
